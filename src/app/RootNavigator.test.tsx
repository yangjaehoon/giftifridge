...
jest.mock('../features/gifticons/browse/HomeScreen', () => () => null);
jest.mock('../features/gifticons/capture/AddGifticonScreen', () => () => null);
jest.mock('../features/gifticons/detail/GifticonDetailScreen', () => () => null);
