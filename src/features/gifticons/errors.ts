import { classifyWriteError } from '../../shared/utils/classifyWriteError';
...
const GIFTICON_ERROR_MESSAGES = {
  ...
  // A request that ran long enough to time out may still have succeeded, so
  // don't tell the user it failed outright.
