...
- **Run/test**: `npm run dev` starts Metro and opens the app on a running Android emulator (Pixel_8). Boot the emulator first (Android Studio Device Manager, or the VS Code "Android iOS Emulator" extension).
